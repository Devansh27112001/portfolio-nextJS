...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("dkansara2711@gmail.com");
    setCopied(true);
  };
  return (
    <div
            ...
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
              <div className="flex flex-col gap-3 lg:gap-3">
                {["React.js", "Next.js", "Typescript"].map((item) => (
                  <span
                    className="py-2 lg:py-3 lg:px-3 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10123e]"
                    key={item}
                  >
                    {item}
                  </span>
              ...
              <div className="flex flex-col gap-3 lg:gap-3">
                ...
                {["Express/Node.js", "Tailwind CSS", "Many More..."].map(
                  (item) => (
                    <span
                      className="py-2 lg:py-3 lg:px-3 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10123E]"
                      key={item}
